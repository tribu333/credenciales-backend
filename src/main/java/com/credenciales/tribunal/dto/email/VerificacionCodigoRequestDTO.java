...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "DTO para verificar código")
public class VerificacionCodigoRequestDTO {
    ...
    @NotBlank(message = "El carnet de identidad es requerido")  // ← AÑADE ESTA LÍNEA
    ...
    private String carnetIdentidad;  // ← ESTE CAMPO FALTABA
