...
@RestController
@RequestMapping("/api/v1/estados-personal")
...
public class EstadoPersonalController {
    ...
    @Operation(
        ...
        description = "Registra un nuevo personal en el sistema y lo coloca en estado PERSONAL REGISTRADO"
    )
    @ApiResponses(value = {
    ...
    public ResponseEntity<PersonalDTO> registrarPersonal(
            @Valid @RequestBody 
            @Parameter(description = "Datos para el registro del personal", required = true) 
            CambioEstadoResquestDTO request) {
        return new ResponseEntity<>(estadoPersonalService.registrarPersonal(request), HttpStatus.CREATED);
    }

    @Operation(
        summary = "Imprimir credencial",
        description = "Cambia el estado del personal a CREDENCIAL IMPRESO. Requiere que el personal esté en estado REGISTRADO."
    )
    @ApiResponses(value = {
    ...
    @Operation(
        summary = "Entregar credencial",
        description = "Entrega la credencial y automáticamente activa al personal (PERSONAL ACTIVO)"
    )
    @ApiResponses(value = {
    ...
    @Operation(
        summary = "Habilitar acceso a cómputo",
        description = "Habilita acceso a cómputo para personal autorizado. Solo si está en estado ACTIVO"
    )
    @ApiResponses(value = {
    ...
    @Operation(
        summary = "Devolver credencial",
        description = "Registra la devolución de la credencial y prepara para inactivación"
    )
    @ApiResponses(value = {
    ...
    @Operation(
        summary = "Finalizar proceso electoral",
        description = "Cambia el estado del personal a INACTIVO por fin de proceso electoral"
    )
    @ApiResponses(value = {
    ...
    @Operation(
        summary = "Registrar renuncia",
        description = "Registra la renuncia del personal desde cualquier estado válido"
    )
    @ApiResponses(value = {
    ...
    @Operation(
        summary = "Obtener personal con estado actual",
        description = "Obtiene la información completa de un personal incluyendo su estado actual"
    )
    @ApiResponses(value = {
    ...
    @Operation(
        summary = "Listar personal por estado",
        description = "Obtiene todos los personales que se encuentran en un estado específico"
    )
    @ApiResponses(value = {
    ...
    public ResponseEntity<List<PersonalDTO>> listarPersonalPorEstado(
            @Parameter(description = "Estado del personal", required = true, 
                      schema = @Schema(implementation = EstadoPersonal.class))
            @PathVariable EstadoPersonal estado) {
        return ResponseEntity.ok(estadoPersonalService.listarPersonalPorEstado(estado));
    }

    @Operation(
        summary = "Obtener historial de estados",
        description = "Obtiene todo el historial de estados por los que ha pasado un personal"
    )
    @ApiResponses(value = {
    ...
    @Operation(
        summary = "Obtener estados permitidos",
        description = "Obtiene los estados a los que puede transitar el personal desde su estado actual"
    )
    ...
    @Operation(
        summary = "Verificar si puede habilitar cómputo",
        description = "Verifica si el personal cumple los requisitos para habilitar acceso a cómputo"
    )
